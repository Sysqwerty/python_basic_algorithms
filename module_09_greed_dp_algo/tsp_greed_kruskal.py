# Алгоритм Краскала — це жадібний алгоритм, який використовується для знаходження мінімального остовного дерева у
# зваженому неорієнтованому графі.

# Часова складність алгоритму переважно залежить від швидкості сортування ребер, яка зазвичай O(ElogE) де E—
# кількість ребер у графі. Сам процес знаходження мінімального остовного дерева має часову складність O(ElogV),
