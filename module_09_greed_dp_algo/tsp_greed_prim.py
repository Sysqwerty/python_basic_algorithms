# Алгоритм Прима — це один жадібний алгоритм, який також використовується для знаходження мінімального остовного
# дерева для зваженого неорієнтованого графа. Відмінність між алгоритмами Прима та Краскала полягає в підході до
# побудови мінімального остовного дерева: алгоритм Краскала працює з ребрами графа, тоді як алгоритм Прима працює з
# вершинами.
